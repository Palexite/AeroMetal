...
The environment you play is made up into modular stages which together, randomized, compromise an infinite roadpath. Traffic is also randomized and features AI behavior.
...
### Options of play
Multiplayer is first priority, especially since we're running on an API that came with the tools primarily designed for this, and thus it may may be the first play option.
...
hanges the flow of the game's procedural generation; making turns and other environmental obstacles more likely.

Additionally, weather can impact the physics of the game. Examples are rain, snow, or wind.
